...
const Partners = () => {
  return (
    <div className="wrapper mt-[80px] sm:mt-[150px]">
      <Title text="Partners" />
      <div className=" w-full mt-8 sm:mt-10 relative isolate">
        <div className="dark:bg-goldGr -inset-y-[1px] w-full absolute left-0 -z-10 "></div>
        <div className="w-full bg-goldGr dark:bg-[#212326] flex justify-center items-center sm:py-4 ">
